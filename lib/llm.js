...
export async function callLLM(messages, options = {}) {
  ...
  if (apiType === 'anthropic') {
    ...
    // Robust content extraction for Anthropic-style response
    // Concatenate all 'text' blocks, skipping 'thinking' or other blocks
    ...
    // Support standard content or reasoning_content (for models like DeepSeek R1)
